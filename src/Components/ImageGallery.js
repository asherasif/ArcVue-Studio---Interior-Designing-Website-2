...
export default function ImageGallery() {
  // ... (useInView hooks and other styles remain unchanged)
  ...
  const allImages = [images, images2, images3 /* ... (other image paths) */];
  ...
  return (
    <>
      {/* ... (existing code for rendering image cards) */}
      ...
      {lightboxOpen && (
        <Lightbox
          images={allImages.flat().map((image) => ({ src: image.src, caption: image.alt }))}
